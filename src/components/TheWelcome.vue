...
onMounted(async() => {
  Cesium.Ion.defaultAccessToken =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiI5Zjc5MWZiOS00OTdhLTQ0NzUtYTgxNy1iMTJmMzNkYzA5MmYiLCJpZCI6MTY0Nzk2LCJpYXQiOjE2OTM5ODE0NjV9.BcGGPwPYeGgB-YBfzmnwIQOoyFJ26wM1G_ZZecDRDXg";
  const viewer = new Cesium.Viewer('cesiumContainer', {
    // terrainProvider: await Cesium.createWorldTerrainAsync(), //建立地形
